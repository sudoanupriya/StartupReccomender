...
def recommend_orgs(investor_id):
    ...
    top_orgs = non_invested_orgs_matrix.iloc[top_org_indices].drop_duplicates()
...
def results(investor_id):
    #check if investor exists or null
    if investor_id is None:
        return "No investor id given"
    elif investor_id not in investor_data['investor_uuid']:
