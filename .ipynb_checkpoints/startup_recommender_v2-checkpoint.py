...
investor_org_matrix = investor_org_matrix.dropna(subset=['short_description']) #category_list
...
org_features = vectorizer.fit_transform(org_data['short_description'])
#print(org_features)
...
def recommend_orgs(investor_id):
    ...
    top_orgs = org_data.iloc[top_org_indices][['org_uuid', 'org_name']].drop_duplicates()
